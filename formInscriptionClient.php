        ...
        <div class="container">
            ...
            <form method="post" action="inscriptionClient.php" id="form" enctype="multipart/form-data" autocomplete="on" novalidate>
                <fieldset>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4 mb-3">
                            <label for="indice"><span class="text-danger">*</span> Date de naissance</label>
                            <input type="date" class="form-control col-md-3" name="dateNaissance" id="dateNaissance" placeholder="DD/MM/YYY" required/>
                            <div class="invalid-feedback">
