<?php
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Activer le tag</h1>
                    <p class="lead fw-normal text-white-50 mb-0">Voulez vous activer ce tag ?</p>
                </div>
            </div>
        </header>
        ...
        <?php
            ...
            if($_POST) {
                $id = $_POST['idtag'];
                $sql = $db->prepare("UPDATE tags SET active = 1 WHERE idTags = $id"); // On désactive le tag en changeant son statut active à 0
                try {
                    $sql->execute();
